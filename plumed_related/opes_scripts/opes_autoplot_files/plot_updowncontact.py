...
set output "time_updowncontact.ps"
#set xrange [0:26]
#set yrange [0:2]
set xlabel "Time (ns)"
set ylabel "up and down contact count"
set tics out
set border 3
set xtics nomirror
set ytics nomirror
...
plot "colvar" every 1 u ($1*0.001):7 with l ls 1 title "up", "colvar" every 1 u ($1*0.001):8 with l ls 2 title "down"
